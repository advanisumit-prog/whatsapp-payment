...
async function printDailyReport(database, dateISO = yesterdayISO(), options = {}) {
    ...
    const out = text => {
        ...
        if (toConsole) console.log(text === undefined ? "" : text);
    };
    ...
    try {
        ...
        // BOM + CRLF: without the BOM, Notepad and PowerShell read UTF-8 as
        // cp1252 and the box-drawing characters come out as "â”€".
