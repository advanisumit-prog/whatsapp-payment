...
async function startBrowser() {
    ...
    const context = await chromium.launchPersistentContext("./session", {
        ...
        args: [
            ...
            // Chromium throttles or pauses windows it thinks are hidden. On an
            // unattended run — or while you work in another app — that stops
            // WhatsApp fetching image thumbnails, and messages get skipped
            // because their media never loads.
